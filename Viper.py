...
# Configuration
host = '10.1.1.168'  # SSH host
port = 22  # SSH port
username = 'marlinspike'  # SSH username
...
def multi_process_ssh_login(credentials, num_processes):
    ...
    with tqdm(total=len(credentials), desc='[*] Bruteforcing Password', colour="white", unit='passwords',leave=False) as pbar:
        results = []
